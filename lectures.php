...
$headname = lang('جــدول الـمــحـاضـرات - موقع طلاب جامعات السودان', 'Lecture schedule - Sudan Un Students Site');
...
<body >
    ...
    <?php
    $pagename = lang('جــدول الـمــحـاضـرات'.' ', 'Lecture schedule');
    ...
    <?php
        include "views/lectures/index.php";
    } else { ?>
        </div>

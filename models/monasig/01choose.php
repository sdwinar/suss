...
?>
        ...
        if ($userinfo['_verified'] == 'no') { ?>
            <span class="badge badge-primary btn-lg" style="font-size: 15px;font-weight: 500;padding: 8px;     width: 100%;  margin-bottom: 5px;"><?php echo lang('عفوا حسابك غير موثق', 'Sorry, your account is not verified') ?></span>
        <?php
        }

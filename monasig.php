...
$headname = lang('منسق الدفعة - موقع طلاب جامعات السودان', 'Batch coordinator - Sudan Un Students Site');
...
<body >
    ...
    <?php
    $pagename = lang('مــنــســق الـدفـــعــــــــــة'.' ', 'Batch Coordinator');
    ...
    <?php
        include "views/monasig/index.php";
    } else { ?>
        </div>

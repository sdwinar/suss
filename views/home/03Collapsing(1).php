    ...
    <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
        ...
        <ul class="list-group">
            ...
            <!-- Submenu content -->
                ...
                <a href="lectures" class="list-group-item list-group-item-action bg-dark text-white">
                <i class="fas fa-users fa-lg"></i>
                    <span style="margin: 0px 14px" class="menu-collapsed"><?php echo lang('جــدول الـمــحـاضـرات'.' ', 'Lecture schedule'); ?></span>
                </a>
                <a href="library" class="list-group-item list-group-item-action bg-dark text-white">
                <i class="fas fa-users fa-lg"></i>
                    <span style="margin: 0px 14px" class="menu-collapsed"><?php echo lang('الـمــكــتــبــة'.' ', 'Library'); ?></span>
                </a>
                <a href="#" class="list-group-item list-group-item-action bg-dark text-white">

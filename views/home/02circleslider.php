...
<?php
echo lang('','<style>.contentCircle {left: 50%;}</style>');
?>
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">   -->
<section class="iq-features" style="top: -51px;position: relative;">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="holderCircle">
                    ...
                    <div class="dotCircle">
                        ...
                        <a href="#"> <span class="itemDot itemDot3" data-tab="3">
                    ...
                    <div class="contentCircle">
                        ...
                        <div class="CirItem title-box CirItem3">
                          <h2 class="title"><span><?php  echo lang('الـمـسـتـخـدمـيـن','USERS') ?></span></h2>
                            <p><?php echo lang('هنالك حقيقة مثبتة من زمن طويل ، يمكنك التعرف بسهولة على شخص من خلال اصدقائه'
                            ,'There is a proven fact from a long time, you can easily identify a person through his friends')?></p>
